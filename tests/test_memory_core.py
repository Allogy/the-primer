...
class TestMemoryCoreIngest:
    async def test_ingest_maps_PreferenceSignal_to_schema_validated_MemoryEntry(self):
        ...
        And a PreferenceSignal whose payload has dimension="history" and content={"courses_completed": ["calc-1"]}
    ...
    async def test_write_ingest_rejects_undeclared_content_field(self):
        ...
        Given a MemoryCore over the education schema where "history" declares fields ["courses_completed", "exercises"]
